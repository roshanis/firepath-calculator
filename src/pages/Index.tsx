  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <main className="section-padding">
        ...
        {/* Legal Disclaimer */}
        <div className="mt-16 sm:mt-24 max-w-4xl mx-auto text-center px-4">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: 0.4 }}
            className="text-xs sm:text-sm text-gray-500 space-y-2"
          >
            <p className="font-semibold">Legal Disclaimer</p>
            <p>
              The information provided by this calculator is for illustrative purposes only and should not be considered as financial, legal, or tax advice. Past performance is not indicative of future results. Investment returns will fluctuate and are subject to market volatility. Your actual results may vary significantly from the examples shown.
            </p>
            <p>
              We strongly recommend consulting with qualified financial, legal, and tax professionals before making any investment, retirement, or financial planning decisions. The projections or other information generated by this calculator regarding the likelihood of various investment outcomes are hypothetical in nature and do not guarantee any specific results.
            </p>
          </motion.div>
        </div>
      </main>
